    ...
    <header>
        ...
        <nav class="navbar">
                <ul class="links">
                    ...
                    <li><a href="ownerlogin.php">Add a property</a></li>
                    <li><a href="registerselect.php"><button > Register </button></a></li>
                    <li><a href="loginselect.php"><button > Login </button></a></li>
                </ul> 
        </nav> 
    </header>
    <section id="head">
        <div class="container">
            <form action="" class="search">
                ...
                <button type="submit"><a href="display.php"><img src="search.png"></a></button>
            </form>
        </div>
    </section>
    <section id="lists">
