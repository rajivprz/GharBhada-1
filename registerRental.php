...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        $sql = "SELECT * FROM renter WHERE username='$username' AND email='$email'";
        ...
        if($row['username']==$username){
            ...
            $add_renter = "INSERT INTO renter (username,email,fullname,password, phonenumber) VALUES('$username','$email','$full_name','$password1', '$number')";
