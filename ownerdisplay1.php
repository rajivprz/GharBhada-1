<?php
session_start();
if(!isset($_SESSION['owner_id']) || $_SESSION['is_owner']==0){
...
<head>
    ...
    <link rel="stylesheet" href="ownerdisplay1.css">
</head>
<body>
    <header>
        ...
        <div class="container">
            <div class="box">
                <table class="tabul" border="1">
                    ...
                    <tr>
                        <th>HOUSE</th>
                        <th><img src="naruto.webp" alt="" class="house"></th>
                        <th>10000</th>
                    </tr>
                </table>
            </div>
